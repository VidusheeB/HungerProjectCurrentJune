...
def run_rf_80_20_test():
    print("=== 80-20 TRAIN-TEST SPLIT: RANDOM FOREST REGRESSOR ===")
    ...
    print("\nTraining RandomForestRegressor on 80% of data...")
    ...
    results_df.to_csv("src/data/random_forest_80_20_test_results.csv", index=False)
    print(f"\nDetailed results saved to: src/data/random_forest_80_20_test_results.csv")
    return results

if __name__ == "__main__":
    try:
        results = run_rf_80_20_test()
        print("\n✅ 80-20 Random Forest regression test completed successfully!")
    except Exception as e:
        print(f"❌ Error during Random Forest 80-20 test: {str(e)}")
        import traceback
        traceback.print_exc() 